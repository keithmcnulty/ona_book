...
`r if (knitr::is_latex_output()) '<!--'`
It is my intention to make all the data sets in the book available in convenient and self-contained packages in R and Python to coincide with the print release of this book in 2022.  In the meantime, the data sets are all accessible via the URLs provided and you can always access them by following the code examples.
`r if (knitr::is_latex_output()) '-->'`
