...
For the next few examples we will return to *Zachary's Karate Club* network from Chapter \@ref(viz-graphs).  Let's load up and visualize that undirected graph and mark the known leading actors Mr Hi and John A with larger vertices, as in Figure \@ref(fig:karate8).
...
Let's reload our Facebook school friends graph and remove any isolates so that we can investigate communities and cliques inside it.
