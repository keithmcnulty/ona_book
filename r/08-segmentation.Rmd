...
ontariopol_edges <- ontariopol_edges[complete.cases(ontariopol_edges), ]
...
## plot
ggraph(ontariopol, layout = "fr") +
  geom_edge_link(color = "grey", alpha = 0.7, arrow = arrow(length = unit(0.2, "cm"))) +
