...
workfrance_edgelist <- read.csv("data/workfrance_edges.csv")

# get vertex set with dept property
workfrance_vertices <- read.csv("data/workfrance_vertices.csv")
